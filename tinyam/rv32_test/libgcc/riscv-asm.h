...
#define FUNC_ALIAS(X,Y)		\
	.globl X;		\
	X = Y
// When using tcc to compile and ld to link, it will complains
// "unknown attribute for symbol `__hidden___udivsi3': 0x04"
// 0x04 is alias tag used internally in tcc, just ignore this
